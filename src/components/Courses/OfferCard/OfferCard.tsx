  ...
  return (
    <div className={styles["offer_card"]}>
      ...
      <div className={styles["link"]}>
        {" "}
        <NavLink to={`/pay/${courseId}/${offerId}`}>
          <span>
            https://course.pro-online.ru/pay/{courseId}/{offerId}
          </span>
        </NavLink>
      </div>
